 ...
 * the measure pass.
 */
public class AwesomeSearchWrapContentLLManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public AwesomeSearchWrapContentLLManager(Context context) {
        super(context);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public AwesomeSearchWrapContentLLManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public AwesomeSearchWrapContentLLManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public AwesomeSearchWrapContentLLManager(RecyclerView view, int orientation, boolean reverseLayout) {
